...
export default function FinBotApp() {
  ...
  return (
    <div className="flex flex-col w-[100vw] h-screen bg-background">
      {" "}
      {/* Simplified background */}
      {/* Enhanced Header */}
      <div className="flex items-center justify-between p-4 border-b border-border bg-card/80 backdrop-blur-sm shadow-sm">
        {" "}
      ...
      <Tabs
        ...
        className="flex-1 flex flex-col max-w-screen-lg mx-auto px-6 py-6"
      >
        <TabsList className="hidden md:grid w-full grid-cols-2 sm:grid-cols-3 md:grid-cols-5 mx-4 mt-4 bg-card/60 backdrop-blur-sm border border-border shadow-sm rounded-xl">
          {" "}
          {/* Toned down shadow, border, rounded corners */}
          <TabsTrigger
            value="overview"
          ...
          <div className="p-4 border-t border-border bg-card/80 backdrop-blur-sm">
            ...
            <form onSubmit={handleSubmit} className="flex gap-2">
              ...
              <Input
                ...
                className="flex-1 h-11 bg-card border border-border focus:border-primary rounded-lg px-3 transition-all duration-200" // Toned down styles
                disabled={isLoading}
              />
              <Button
                type="submit"
                ...
                className="h-11 w-11 rounded-lg bg-primary hover:bg-primary/90 shadow-sm hover:shadow-md transition-all duration-200 interactive-button" // Toned down styles
              >
        ...
        <TabsContent
          value="investments"
          className="flex-1 max-w-screen-lg mx-auto px-6 py-6 animate-slide-up"
        >
          <InvestmentDashboard />
        </TabsContent>
      </Tabs>
