...
import { PieChart, AlertTriangle, Info, Star, ArrowUpRight, TrendingUp, Sparkles, Zap } from "lucide-react"
      ...
      <div className="grid grid-cols-2 gap-6">
        <Card className="interactive-card bg-card/80 backdrop-blur-sm border border-border shadow-sm">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm text-blue-600 dark:text-blue-400 font-medium">Portfolio Value</div>
        ...
        <Card className="interactive-card bg-card/80 backdrop-blur-sm border border-border shadow-sm">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm text-purple-600 dark:text-purple-400 font-medium">Total Invested</div>
        ...
        <Card className="interactive-card bg-card/80 backdrop-blur-sm border border-border shadow-sm">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm text-orange-600 dark:text-orange-400 font-medium">Return %</div>
